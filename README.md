...
<sub>02 · ZPE Music animated mechanics diagram · b-cell b-codec-mechanics cell-5 row-2</sub>
<figure>
...
<div><b>02 · MARKETS</b><span>ADJACENT FORECASTS</span></div>
      <div>
        <div>
          <div><span>Music publishing</span><span></span><span>'32 · $13.7B</span></div>
          <div><span>Music publishing</span><span></span><span>'30 · $10.8B</span></div>
          <div><span>Digital sheet music</span><span></span><span>'34 · $4.2B</span></div>
          <div><span>Music education software</span><span></span><span>est. $3.4B</span></div>
          <div><span>Rights management / score archive</span><span></span><span>est. $1.2B</span></div>
        </div>
      </div>
...
<div><b>05.3 · BENCHMARKS</b><span>MUSICXML SCORE SURFACE</span></div>
      <div>
        ...
        <div>
          <div><span>SCORE_EVENT</span><span></span><span>1.000</span></div>
          <div><span>5 other axes</span><span></span><span>1.000</span></div>
          <div><span>real-corpus</span><span></span><span>pending</span></div>
        </div>
      </div>
...
<div><b>06.1 · COMPARATIVE PERFORMANCE</b><span>MUSICXML 4.0 SCORE SURFACE</span></div>
      <div>
        <div>
          <div><span>SCORE_EVENT</span><span></span><span>1.000</span></div>
          <div><span>PART</span><span></span><span>1.000</span></div>
          <div><span>ARTICULATION</span><span></span><span>1.000</span></div>
          <div><span>EXPRESSION · PERF_TUPLE · REPEATED_NOTE</span><span></span><span>1.000</span></div>
        </div>
      </div>
